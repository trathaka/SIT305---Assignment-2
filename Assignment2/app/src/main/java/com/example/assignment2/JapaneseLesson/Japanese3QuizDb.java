...
import com.example.assignment2.JapaneseLesson.Japanese3QuizContract.QuestionsTable;

import java.util.ArrayList;

public class Japanese3QuizDb extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "Japanese3.db";
    private static final int DATABASE_VERSION = 1;

    private SQLiteDatabase db;

    public Japanese3QuizDb(@Nullable Context context) {
