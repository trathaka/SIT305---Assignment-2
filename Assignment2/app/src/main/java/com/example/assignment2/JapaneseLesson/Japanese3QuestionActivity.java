...
public class Japanese3QuestionActivity extends AppCompatActivity {
    ...
    private ArrayList<Japanese3Question> questionList;
    private int questionCounter;
    private int questionCountTotal;
    private Japanese3Question currentQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String difficulty = intent.getStringExtra(Japanese3Activity.EXTRA_DIFFICULTY);
        ...
        if (savedInstanceState == null) {
            ...
            Japanese3QuestionDatabase dbHelper = new Japanese3QuestionDatabase(this);
            ...
            public void onClick(View v) {
                ...
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                        ...
                        Toast.makeText(Japanese3QuestionActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
