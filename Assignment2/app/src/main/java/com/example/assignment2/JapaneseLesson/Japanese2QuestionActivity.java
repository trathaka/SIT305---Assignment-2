...
public class Japanese2QuestionActivity extends AppCompatActivity {
    ...
    private ArrayList<Japanese2Question> questionList;
    private int questionCounter;
    private int questionCountTotal;
    private Japanese2Question currentQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String difficulty = intent.getStringExtra(Japanese2Activity.EXTRA_DIFFICULTY);
        ...
        if (savedInstanceState == null) {
            ...
            Japanese2QuestionDatabase dbHelper = new Japanese2QuestionDatabase(this);
            ...
            public void onClick(View v) {
                ...
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                        ...
                        Toast.makeText(Japanese2QuestionActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
