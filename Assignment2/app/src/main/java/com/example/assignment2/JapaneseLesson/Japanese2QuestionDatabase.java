...
import com.example.assignment2.JapaneseLesson.Japanese2QuestionContract.QuestionsTable;
import java.util.ArrayList;

public class Japanese2QuestionDatabase extends SQLiteOpenHelper {
    ...
    public Japanese2QuestionDatabase(@Nullable Context context) {
