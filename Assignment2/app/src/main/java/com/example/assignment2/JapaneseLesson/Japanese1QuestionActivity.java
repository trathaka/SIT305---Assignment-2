...
public class Japanese1QuestionActivity extends AppCompatActivity {
    ...
    private ArrayList<Japanese1Question> questionList;
    private int questionCounter;
    private int questionCountTotal;
    private Japanese1Question currentQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String difficulty = intent.getStringExtra(Japanese1Activity.EXTRA_DIFFICULTY);

        textViewDifficulty.setText("Difficulty: " + difficulty);

        if (savedInstanceState == null) {
            // Initialize QuestionDatabase class
            Japanese1QuestionDatabase dbHelper = new Japanese1QuestionDatabase(this);
            ...
            public void onClick(View v) {
                ...
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                        ...
                        Toast.makeText(Japanese1QuestionActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
