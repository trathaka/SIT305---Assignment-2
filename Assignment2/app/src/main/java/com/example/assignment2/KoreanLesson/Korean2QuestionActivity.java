...
public class Korean2QuestionActivity extends AppCompatActivity {
    ...
    private ArrayList<Korean2Question> questionList;
    private int questionCounter;
    private int questionCountTotal;
    private Korean2Question currentQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String difficulty = intent.getStringExtra(Korean2Activity.EXTRA_DIFFICULTY);
        ...
        if (savedInstanceState == null) {
            ...
            Korean2QuestionDatabase dbHelper = new Korean2QuestionDatabase(this);
            ...
            public void onClick(View v) {
                ...
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                        ...
                        Toast.makeText(Korean2QuestionActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
