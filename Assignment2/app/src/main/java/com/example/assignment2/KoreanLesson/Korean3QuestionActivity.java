...
public class Korean3QuestionActivity extends AppCompatActivity {
    ...
    private ArrayList<Korean3Question> questionList;
    private int questionCounter;
    private int questionCountTotal;
    private Korean3Question currentQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String difficulty = intent.getStringExtra(Korean3Activity.EXTRA_DIFFICULTY);
        ...
        if (savedInstanceState == null) {
            ...
            Korean3QuestionDatabase dbHelper = new Korean3QuestionDatabase(this);
            ...
            public void onClick(View v) {
                ...
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                        ...
                        Toast.makeText(Korean3QuestionActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
