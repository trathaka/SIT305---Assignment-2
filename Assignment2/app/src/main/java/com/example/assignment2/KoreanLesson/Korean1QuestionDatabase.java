...
import com.example.assignment2.KoreanLesson.Korean1QuestionContract.*;
import androidx.annotation.Nullable;
import java.util.ArrayList;

public class Korean1QuestionDatabase extends SQLiteOpenHelper {
    ...
    public Korean1QuestionDatabase(@Nullable Context context) {
