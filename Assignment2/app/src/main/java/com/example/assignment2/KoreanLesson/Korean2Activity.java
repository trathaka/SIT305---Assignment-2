...
public class Korean2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_korean2_activity);

        textViewHighScore = findViewById(R.id.text_view_highscore);
        loadHighScore();
        spinnerDifficulty = findViewById(R.id.spinner_difficulty);

        String[] difficultyLevels = Korean2Question.getAllDifficultyLevels();
    ...
    private void startExercise() {
        ...
        Intent intent = new Intent(Korean2Activity.this, Korean2QuestionActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CODE_QUIZ){
            if (resultCode == RESULT_OK){
                int score = data.getIntExtra(Korean2QuestionActivity.EXTRA_SCORE,0);
                if (score > highScore){
